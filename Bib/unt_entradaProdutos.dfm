object F_EntradaProdutos: TF_EntradaProdutos
  Left = 282
  Top = 164
  ...
  object mask_preco: TMaskEdit
    Left = 72
    Top = 87
    Width = 68
    Height = 21
    Hint = '>>> Informe o pre'#231'o do produto no formato 0,00'
    Color = clSkyBlue
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
  ...
  object edt_requisicao: TEdit
    ...
    Width = 67
    Height = 21
    Hint = '>>> Entre com o n'#250'mero da Requisi'#231#227'o Interna'
    Color = clSkyBlue
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
