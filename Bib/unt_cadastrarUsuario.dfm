object F_CadastrarUsuario: TF_CadastrarUsuario
  Left = 214
  Top = 131
  ...
  object edt_NomeUsuario: TEdit
    ...
    ParentFont = False
    TabOrder = 2
    OnKeyPress = edt_NomeUsuarioKeyPress
  end
  object edt_LoginUsuario: TEdit
    Left = 71
    Top = 16
    Width = 129
    Height = 21
    ...
    ParentFont = False
    TabOrder = 1
    OnKeyPress = edt_LoginUsuarioKeyPress
  end
  object cbPerfilUsuario: TComboBox
    Left = 72
    Top = 60
    Width = 161
    Height = 21
