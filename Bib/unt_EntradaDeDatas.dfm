object Filtro_Entradas: TFiltro_Entradas
  Left = 300
  Top = 172
  ...
  object RG_TiposRelatorios: TRadioGroup
    Left = 8
    Top = 4
    Width = 577
    Height = 145
    ...
    ParentFont = False
    TabOrder = 3
    OnClick = RG_TiposRelatoriosClick
    OnEnter = RG_TiposRelatoriosEnter
  end
  object Panel4: TPanel
    ...
    object cbSolicitantes: TComboBox
      Left = 110
      Top = 12
      Width = 460
      Height = 21
