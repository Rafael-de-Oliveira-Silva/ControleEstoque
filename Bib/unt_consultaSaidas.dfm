object F_ConsultaSaidas: TF_ConsultaSaidas
  Left = 231
  Top = 144
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Hist'#243'rico de Sa'#237'das'
  ClientHeight = 431
  ClientWidth = 920
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lbl_pesquisaRapida: TLabel
    Left = 15
    Top = 15
    Width = 323
    Height = 16
    Caption = '>>> CONSULTE O HIST'#211'RICO DE SA'#205'DAS <<<'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object DBGrid1: TDBGrid
    ...
    Width = 905
    Height = 289
    DataSource = DM_Banco.dsConsultaSaida
  ...
  object painelCampos: TPanel
    ...
    object edt_Solicitante: TEdit
      ...
      Enabled = False
      TabOrder = 3
      OnKeyPress = edt_SolicitanteKeyPress
    end
  end
